...
if (_building getVariable ["owner",""] isNotEqualTo "") exitWith {["This building is owned already.","orange"] call DT_fnc_notify};

closeDialog 0;
private _class = typeOf _building;
private _taxPercentage = 1 + ((gov_taxArray select 2) / 100);
